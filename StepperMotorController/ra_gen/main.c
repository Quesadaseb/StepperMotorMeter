...
extern void thread0_main_create(void);
extern void thread1_motor_drive_create(void);
extern void thread2_monitor_create(void);
...
void tx_application_define(void *first_unused_memory)
{
    ...
    thread0_main_create ();
    thread1_motor_drive_create ();
    thread2_monitor_create ();
